...
```python file=/concepts/ops_jobs_graphs/pipelines.py startafter=start_multiple_usage_pipeline endbefore=end_multiple_usage_pipeline
ENOENT: no such file or directory, open '/Users/sryza/dagster/examples/docs_snippets/docs_snippets/concepts/ops_jobs_graphs/pipelines.py'
```
...
```python file=/concepts/ops_jobs_graphs/pipelines.py startafter=start_alias_pipeline endbefore=end_alias_pipeline
ENOENT: no such file or directory, open '/Users/sryza/dagster/examples/docs_snippets/docs_snippets/concepts/ops_jobs_graphs/pipelines.py'
```
...
```python file=/concepts/ops_jobs_graphs/pipelines.py startafter=start_pipeline_definition_marker endbefore=end_pipeline_definition_marker
ENOENT: no such file or directory, open '/Users/sryza/dagster/examples/docs_snippets/docs_snippets/concepts/ops_jobs_graphs/pipelines.py'
```
